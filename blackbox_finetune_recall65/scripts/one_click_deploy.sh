...
DEFAULT_DATA_DIR="blackbox_finetune_recall65/data_no_partial_week_$SAMPLE_MODE"
DEFAULT_VALIDATION_DATA_DIR="blackbox_finetune_recall65/data_evaluation_no_partial_week_$SAMPLE_MODE"
DATA_DIR="${DATA_DIR:-$DEFAULT_DATA_DIR}"
VALIDATION_DATA_DIR="${VALIDATION_DATA_DIR:-$DEFAULT_VALIDATION_DATA_DIR}"
if [[ "$SAMPLE_MODE" == "short" ]]; then
  DEFAULT_OUTPUT_DIR="blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-short-lora"
elif [[ "$SAMPLE_MODE" == "xlong" ]]; then
  DEFAULT_OUTPUT_DIR="blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-xlong-lora"
elif [[ "$SAMPLE_MODE" == "xxlong" ]]; then
  DEFAULT_OUTPUT_DIR="blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-xxlong-lora"
else
  DEFAULT_OUTPUT_DIR="blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-long-lora"
fi
