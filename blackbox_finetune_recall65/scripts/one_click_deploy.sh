...
DATA_DIR="${DATA_DIR:-blackbox_finetune_recall65/data_no_partial_week}"
VALIDATION_DATA_DIR="${VALIDATION_DATA_DIR:-blackbox_finetune_recall65/data_evaluation_no_partial_week}"
