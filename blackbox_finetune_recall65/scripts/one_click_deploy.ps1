...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-short-lora" } else { "blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-long-lora" }
