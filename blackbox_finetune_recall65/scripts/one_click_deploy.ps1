...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-xlong-lora" } else { "blackbox_finetune_recall65/runs/qwen2.5-0.5b-blackbox-recall65-long-lora" }
