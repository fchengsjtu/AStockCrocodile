...
from blackbox_finetune_recall65.common import DEFAULT_BASE_MODEL, DEFAULT_DATA_DIR, DEFAULT_MAX_SEQ_LENGTH, DEFAULT_TRAIN_SEED, compact_messages_from_sample, default_max_seq_length, default_output_dir
from blackbox_finetune_recall65.gpu import prepare_rtx3060
from blackbox_finetune_recall65.inference import score_prediction
...
def _missing_dataset_error(data_dir: Path) -> FileNotFoundError:
    return FileNotFoundError(f"missing dataset files under {data_dir}; run blackbox_finetune_recall65.build_dataset first")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Fine-tune Qwen2.5 for recall65 black-box stock classification")
    ...
    parser.add_argument("--no-4bit", action="store_true", help="Accepted for script compatibility; recall65 Windows training uses fp16 LoRA on RTX3060.")
