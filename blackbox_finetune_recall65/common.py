...
DEFAULT_DATA_DIR = Path("blackbox_finetune_recall65") / "data_no_partial_week"
DEFAULT_VALIDATION_DIR = Path("blackbox_finetune_recall65") / "data_evaluation_no_partial_week"
DEFAULT_OUTPUT_DIR = Path("blackbox_finetune_recall65") / "runs" / "qwen2.5-0.5b-blackbox-recall65-lora"
