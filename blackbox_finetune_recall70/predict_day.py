...
from blackbox_finetune_recall70.common import (
    DEFAULT_BASE_MODEL,
    DEFAULT_OUTPUT_DIR,
    DEFAULT_SAMPLE_MODE,
    DEFAULT_WINDOW,
...
def predict_day(
    ...
    with mysql_connect() as conn:
        ...
        print(f"blackbox recall70 predict date={anchor} symbols={len(symbols)} batches={len(batches)}", flush=True)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Predict one trading day with recall70 black-box model")
