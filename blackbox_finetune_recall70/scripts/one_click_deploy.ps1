...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall70/runs/qwen2.5-0.5b-blackbox-recall70-short-lora" } else { "blackbox_finetune_recall70/runs/qwen2.5-0.5b-blackbox-recall70-long-lora" }
