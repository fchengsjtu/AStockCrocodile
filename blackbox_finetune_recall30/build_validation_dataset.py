...
from blackbox_finetune_recall30.build_dataset import build_recall30_dataset
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build recall30 validation dataset")
