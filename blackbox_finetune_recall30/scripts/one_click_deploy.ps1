...
$DefaultDataDir = "blackbox_finetune_recall30/data_no_partial_week_$SampleMode"
$DefaultValidationDir = "blackbox_finetune_recall30/data_evaluation_no_partial_week_$SampleMode"
