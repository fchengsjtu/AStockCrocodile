...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall30/runs/qwen2.5-0.5b-blackbox-recall30-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall30/runs/qwen2.5-0.5b-blackbox-recall30-xlong-lora" } else { "blackbox_finetune_recall30/runs/qwen2.5-0.5b-blackbox-recall30-long-lora" }
