...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-xlong-lora" } else { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-long-lora" }
