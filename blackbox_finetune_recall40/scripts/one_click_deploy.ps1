...
$DefaultDataDir = "blackbox_finetune_recall40/data_no_partial_week_$SampleMode"
$DefaultValidationDir = "blackbox_finetune_recall40/data_evaluation_no_partial_week_$SampleMode"
...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-xlong-lora" } elseif ($SampleMode -eq "xxlong") { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-xxlong-lora" } else { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-long-lora" }
