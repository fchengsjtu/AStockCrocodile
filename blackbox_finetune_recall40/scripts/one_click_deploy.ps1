...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-short-lora" } else { "blackbox_finetune_recall40/runs/qwen2.5-0.5b-blackbox-recall40-long-lora" }
