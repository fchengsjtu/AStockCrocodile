...
def recall_target_tag(value: str | float | int | None = None) -> str:
    return os.environ.get("MODEL_TAG") or os.environ.get("DOWNSIDE_TAG") or DEFAULT_MODEL_TAG
