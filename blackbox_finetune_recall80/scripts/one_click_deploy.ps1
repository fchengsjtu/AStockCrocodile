...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall80/runs/qwen2.5-0.5b-blackbox-recall80-short-lora" } else { "blackbox_finetune_recall80/runs/qwen2.5-0.5b-blackbox-recall80-long-lora" }
