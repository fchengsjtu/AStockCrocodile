...
from blackbox_finetune_recall80.inference import score_prediction
...
def train_recall80_lora(
    ...
    print(
        ...
        f"max_seq_length={active_max_seq_length} min_seq_length_on_oom={min_seq_length_on_oom} eval_every={evaluation_interval_fraction} eval_threshold={evaluation_threshold} eval_max_samples={evaluation_max_samples}",
        flush=True,
    )
