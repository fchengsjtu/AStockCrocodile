...
from blackbox_finetune_recall80.build_dataset import build_recall80_dataset
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build recall80 validation dataset")
