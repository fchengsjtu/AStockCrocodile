...
DEFAULT_DATA_DIR = Path("blackbox_finetune_recall60") / "data_no_partial_week"
DEFAULT_VALIDATION_DIR = Path("blackbox_finetune_recall60") / "data_evaluation_no_partial_week"
