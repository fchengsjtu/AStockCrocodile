...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall60/runs/qwen2.5-0.5b-blackbox-recall60-short-lora" } else { "blackbox_finetune_recall60/runs/qwen2.5-0.5b-blackbox-recall60-long-lora" }
