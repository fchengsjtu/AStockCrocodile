...
$DataDir = if ($env:DATA_DIR) { $env:DATA_DIR } else { "blackbox_finetune_recall60/data_no_partial_week" }
$ValidationDir = if ($env:VALIDATION_DATA_DIR) { $env:VALIDATION_DATA_DIR } else { "blackbox_finetune_recall60/data_evaluation_no_partial_week" }
...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall60/runs/qwen2.5-0.5b-blackbox-recall60-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall60/runs/qwen2.5-0.5b-blackbox-recall60-xlong-lora" } else { "blackbox_finetune_recall60/runs/qwen2.5-0.5b-blackbox-recall60-long-lora" }
