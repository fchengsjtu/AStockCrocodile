...
POSITIVE_LOSS_WEIGHT="${POSITIVE_LOSS_WEIGHT:-1.2}"
...
if train_supports_arg "--drop6-negative-loss-weight"; then
  TRAIN_ARGS+=(--drop6-negative-loss-weight "$DROP6_NEGATIVE_LOSS_WEIGHT")
fi
