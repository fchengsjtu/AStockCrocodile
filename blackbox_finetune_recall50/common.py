...
DEFAULT_DATA_DIR = Path("blackbox_finetune_recall50") / "data"
DEFAULT_VALIDATION_DIR = Path("blackbox_finetune_recall50") / "data_validation"
DEFAULT_OUTPUT_DIR = Path("blackbox_finetune_recall50") / "runs" / "qwen2.5-0.5b-blackbox-recall50-lora"
