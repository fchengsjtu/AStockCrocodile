...
$DefaultDataDir = "blackbox_finetune_recall50/data_no_partial_week_$SampleMode"
$DefaultValidationDir = "blackbox_finetune_recall50/data_evaluation_no_partial_week_$SampleMode"
