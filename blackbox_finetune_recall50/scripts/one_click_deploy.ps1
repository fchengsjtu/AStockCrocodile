...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall50/runs/qwen2.5-0.5b-blackbox-recall50-short-lora" } else { "blackbox_finetune_recall50/runs/qwen2.5-0.5b-blackbox-recall50-long-lora" }
