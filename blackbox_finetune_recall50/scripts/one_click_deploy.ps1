...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall50/runs/qwen2.5-0.5b-blackbox-recall50-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall50/runs/qwen2.5-0.5b-blackbox-recall50-xlong-lora" } else { "blackbox_finetune_recall50/runs/qwen2.5-0.5b-blackbox-recall50-long-lora" }
