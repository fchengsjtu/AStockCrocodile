...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall55/runs/qwen2.5-0.5b-blackbox-recall55-short-lora" } else { "blackbox_finetune_recall55/runs/qwen2.5-0.5b-blackbox-recall55-long-lora" }
