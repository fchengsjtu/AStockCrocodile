...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall55/runs/qwen2.5-0.5b-blackbox-recall55-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall55/runs/qwen2.5-0.5b-blackbox-recall55-xlong-lora" } else { "blackbox_finetune_recall55/runs/qwen2.5-0.5b-blackbox-recall55-long-lora" }
