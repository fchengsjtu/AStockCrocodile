...
if [[ "$SAMPLE_MODE" == "short" ]]; then
  ...
  DEFAULT_OUTPUT_DIR="blackbox_finetune_recall35/runs/qwen2.5-0.5b-blackbox-recall35-xlong-lora"
elif [[ "$SAMPLE_MODE" == "xxlong" ]]; then
  DEFAULT_OUTPUT_DIR="blackbox_finetune_recall35/runs/qwen2.5-0.5b-blackbox-recall35-xxlong-lora"
else
  DEFAULT_OUTPUT_DIR="blackbox_finetune_recall35/runs/qwen2.5-0.5b-blackbox-recall35-long-lora"
fi
