...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall35/runs/qwen2.5-0.5b-blackbox-recall35-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall35/runs/qwen2.5-0.5b-blackbox-recall35-xlong-lora" } else { "blackbox_finetune_recall35/runs/qwen2.5-0.5b-blackbox-recall35-long-lora" }
