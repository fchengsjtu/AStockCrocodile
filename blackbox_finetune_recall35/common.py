...
DEFAULT_DATA_DIR = Path("blackbox_finetune_recall35") / "data_no_partial_week"
DEFAULT_VALIDATION_DIR = Path("blackbox_finetune_recall35") / "data_evaluation_no_partial_week"
DEFAULT_OUTPUT_DIR_SHORT = Path("blackbox_finetune_recall35") / "runs" / "qwen2.5-0.5b-blackbox-recall35-short-lora"
DEFAULT_OUTPUT_DIR_LONG = Path("blackbox_finetune_recall35") / "runs" / "qwen2.5-0.5b-blackbox-recall35-long-lora"
DEFAULT_OUTPUT_DIR_XLONG = Path("blackbox_finetune_recall35") / "runs" / "qwen2.5-0.5b-blackbox-recall35-xlong-lora"
DEFAULT_OUTPUT_DIR_XXLONG = Path("blackbox_finetune_recall35") / "runs" / "qwen2.5-0.5b-blackbox-recall35-xxlong-lora"
...
DEFAULT_MIN_POSITIVE_RECALL = 0.35
DEFAULT_TRAIN_SEED = 20260535
