...
DEFAULT_DATA_DIR = Path("blackbox_finetune_recall75") / "data_no_partial_week"
DEFAULT_VALIDATION_DIR = Path("blackbox_finetune_recall75") / "data_evaluation_no_partial_week"
DEFAULT_OUTPUT_DIR_SHORT = Path("blackbox_finetune_recall75") / "runs" / "qwen2.5-0.5b-blackbox-recall75-short-lora"
DEFAULT_OUTPUT_DIR_LONG = Path("blackbox_finetune_recall75") / "runs" / "qwen2.5-0.5b-blackbox-recall75-long-lora"
DEFAULT_OUTPUT_DIR_XLONG = Path("blackbox_finetune_recall75") / "runs" / "qwen2.5-0.5b-blackbox-recall75-xlong-lora"
DEFAULT_OUTPUT_DIR_XXLONG = Path("blackbox_finetune_recall75") / "runs" / "qwen2.5-0.5b-blackbox-recall75-xxlong-lora"
...
DEFAULT_MIN_POSITIVE_RECALL = 0.75
DEFAULT_TRAIN_SEED = 20260575
