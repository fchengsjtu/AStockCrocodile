...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall75/runs/qwen2.5-0.5b-blackbox-recall75-short-lora" } else { "blackbox_finetune_recall75/runs/qwen2.5-0.5b-blackbox-recall75-long-lora" }
