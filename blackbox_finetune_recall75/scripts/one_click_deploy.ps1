...
$DefaultDataDir = "blackbox_finetune_recall75/data_no_partial_week_$SampleMode"
$DefaultValidationDir = "blackbox_finetune_recall75/data_evaluation_no_partial_week_$SampleMode"
