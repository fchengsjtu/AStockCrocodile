...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall75/runs/qwen2.5-0.5b-blackbox-recall75-short-lora" } elseif ($SampleMode -eq "xlong") { "blackbox_finetune_recall75/runs/qwen2.5-0.5b-blackbox-recall75-xlong-lora" } else { "blackbox_finetune_recall75/runs/qwen2.5-0.5b-blackbox-recall75-long-lora" }
