...
DEFAULT_DATA_DIR="blackbox_finetune_recall75/data_no_partial_week_$SAMPLE_MODE"
DEFAULT_VALIDATION_DATA_DIR="blackbox_finetune_recall75/data_evaluation_no_partial_week_$SAMPLE_MODE"
