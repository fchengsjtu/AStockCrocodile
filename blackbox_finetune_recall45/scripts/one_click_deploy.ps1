...
$DefaultOutputDir = if ($SampleMode -eq "short") { "blackbox_finetune_recall45/runs/qwen2.5-0.5b-blackbox-recall45-short-lora" } else { "blackbox_finetune_recall45/runs/qwen2.5-0.5b-blackbox-recall45-long-lora" }
...
$BuildArgs = @("-m", "blackbox_finetune_recall45.build_dataset", "--output-dir", $DataDir, "--start-date", $TrainStart, "--end-date", $TrainEnd, "--negative-ratio", $NegativeRatio, "--sample-mode", $SampleMode)
...
$ValArgs = @("-m", "blackbox_finetune_recall45.build_validation_dataset", "--output-dir", $ValidationDir, "--start-date", $ValidationStart, "--end-date", $ValidationEnd, "--negative-ratio", $NegativeRatio, "--sample-mode", $SampleMode)
