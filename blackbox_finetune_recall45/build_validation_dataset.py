...
from blackbox_finetune_recall45.build_dataset import build_recall45_dataset
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build recall45 validation dataset")
