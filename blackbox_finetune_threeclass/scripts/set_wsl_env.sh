...
export FP_LOSS_WEIGHT="${FP_LOSS_WEIGHT:-0.1}"
export NEUTRAL_FP_LOSS_WEIGHT="${NEUTRAL_FP_LOSS_WEIGHT:-0.1}"
export HIGH_SCORE_POSITIVE_BONUS="${HIGH_SCORE_POSITIVE_BONUS:-2.0}"
export HIGH_SCORE_POSITIVE_BONUS_MAX_MULTIPLIER="${HIGH_SCORE_POSITIVE_BONUS_MAX_MULTIPLIER:-10.0}"
export HIGH_SCORE_NEGATIVE_PENALTY_WEIGHT="${HIGH_SCORE_NEGATIVE_PENALTY_WEIGHT:-2.0}"
export HIGH_SCORE_NEUTRAL_PENALTY_WEIGHT="${HIGH_SCORE_NEUTRAL_PENALTY_WEIGHT:-1}"
