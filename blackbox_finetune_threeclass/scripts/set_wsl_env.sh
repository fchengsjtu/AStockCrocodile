...
export DATA_DIR="${DATA_DIR:-blackbox_finetune_threeclass/data_xlong_p1_n2_u10}"
export VALIDATION_DATA_DIR="${VALIDATION_DATA_DIR:-blackbox_finetune_threeclass/data_evaluation_xlong_p1_n2_u10}"
export OUTPUT_DIR="${OUTPUT_DIR:-blackbox_finetune_threeclass/runs/qwen2.5-0.5b-threeclass-xlong-lora}"
