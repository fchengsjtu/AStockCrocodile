...
DEFAULT_DATA_DIR = PROJECT_DIR / f"data_{DEFAULT_SAMPLE_MODE}_p1_n2_u10"
DEFAULT_VALIDATION_DIR = PROJECT_DIR / f"data_evaluation_{DEFAULT_SAMPLE_MODE}_p1_n2_u10"
DEFAULT_OUTPUT_DIR = PROJECT_DIR / "runs" / f"qwen2.5-0.5b-threeclass-{DEFAULT_SAMPLE_MODE}-lora"
