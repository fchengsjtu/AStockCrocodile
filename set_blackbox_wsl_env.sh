...
export NEGATIVE_RATIO="${NEGATIVE_RATIO_OVERRIDE:-5.0}"
export SAMPLE_BOTTOM_BAND_RATIO="${SAMPLE_BOTTOM_BAND_RATIO:-1.0}"

export CHECKPOINT_EVERY="${CHECKPOINT_EVERY:-100}"
export EVAL_THRESHOLD="${EVAL_THRESHOLD_OVERRIDE:-0.4}"
export EVAL_THRESHOLD_POSITION="${EVAL_THRESHOLD_POSITION:-0.2}"
...
export POSITIVE_LOSS_WEIGHT="${POSITIVE_LOSS_WEIGHT:-1.2}"
export NEGATIVE_LOSS_WEIGHT="${NEGATIVE_LOSS_WEIGHT:-1.0}"
export DROP6_NEGATIVE_LOSS_WEIGHT="${DROP6_NEGATIVE_LOSS_WEIGHT:-1.2}"
export NEUTRAL_NEGATIVE_LOSS_WEIGHT="${NEUTRAL_NEGATIVE_LOSS_WEIGHT:-1.0}"
export HIGH_SCORE_POSITIVE_BONUS="${HIGH_SCORE_POSITIVE_BONUS:-0.0}"
export HIGH_SCORE_POSITIVE_POSITION="${HIGH_SCORE_POSITIVE_POSITION:-0.8}"
export FP_DYNAMIC_PENALTY="${FP_DYNAMIC_PENALTY:-1}"
export FP_PENALTY_WEIGHT="${FP_PENALTY_WEIGHT:-1.0}"
export FP_THRESHOLD_EMA_ALPHA="${FP_THRESHOLD_EMA_ALPHA:-0.2}"
export FP_THRESHOLD_MIN="${FP_THRESHOLD_MIN:-0.4}"
export FP_THRESHOLD_MAX="${FP_THRESHOLD_MAX:-0.65}"
...
printf '%s\n' \
  ...
  "  ASTOCK_DISABLE_LOCAL_DEPS=$ASTOCK_DISABLE_LOCAL_DEPS" \
  ...
  "  EXPLICIT_DATASET_WORK_DIR=${EXPLICIT_DATASET_WORK_DIR:-<auto-under-output-dir>}" \
